export default class characterSelection extends Phaser.Scene {
    ...
    init(data) {
        ...
        this.players = (() => {
            const playerNames = data?.userNFTsNames.map(obj => obj.name);
    ...
    preload() {
        this.load.image(
            "character_bg",
            "assets/images/characters/character_bg.png"
        );
    ...
    create() {
        ...
        this.players.forEach(function (player, index) {
            ...
            characters[index] = ref.add.image(gape, innerHeight / 2, player);
            ref.add.text(
                index === 0 ? gape - 40 : gape - 20,
                innerHeight / 2 + 100,
                player,
                {
